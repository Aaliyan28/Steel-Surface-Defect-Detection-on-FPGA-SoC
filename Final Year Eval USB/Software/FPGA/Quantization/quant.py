...
parser.add_argument('--data_dir',default="neugc10/valid/images/",
    help='Data set directory, when quant_mode=calib, it is for calibration, while quant_mode=test it is for evaluation')
parser.add_argument('--model_dir',default="final_models/",
...
def quantization(title='optimize',file_path=''):
    ...
    input = torch.randn([1, 3, 416, 416],device=device)
    if quant_mode == 'float':
        quant_model = model
    else:
